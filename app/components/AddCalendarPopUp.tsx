        ...
        <div className="space-y-3">
          ...
          <div className="pt-3 mt-3 border-t space-y-3">
            ...
            <button
              ...
              className="flex items-center p-3 border rounded-lg hover:bg-gray-50 transition-colors w-full text-left"
            >
              <img src="/img/calendar/copy-link.svg" alt="Copier le lien" className="w-8 h-8 mr-3" />
              <span className="font-medium">{copiedUrl ? '✓ Lien copié !' : 'Copier le lien du calendrier .ics'}</span>
            </button>
          </div>
        </div>
